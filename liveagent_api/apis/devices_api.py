...
class DevicesApi(object):
    ...
    def get_my_mobile_devices_list(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_my_mobile_devices_list(callback=callback_function)
        ...
        resource_path = '/devices/_app_/'.replace('{format}', 'json')
        path_params = {}
