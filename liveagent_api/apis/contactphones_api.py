...
class ContactphonesApi(object):
    ...
    def get_contact_phone(self, phone, **kwargs):
        """
        Get contact phone
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_contact_phone(phone, callback=callback_function)
        ...
        if ('phone' not in params) or (params['phone'] is None):
            raise ValueError("Missing the required parameter `phone` when calling `get_contact_phone`")

        resource_path = '/contact_phones/{phone}'.replace('{format}', 'json')
        path_params = {}
        if 'phone' in params:
            path_params['phone'] = params['phone']
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            response_type='ContactPhone',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def get_contact_phones_list(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_contact_phones_list(callback=callback_function)
        ...
        resource_path = '/contact_phones'.replace('{format}', 'json')
        path_params = {}
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='list[ContactPhone]',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
