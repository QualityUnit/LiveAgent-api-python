...
class TagsApi(object):
    ...
    def delete_tag(self, tag_id, **kwargs):
        ...
        resource_path = '/tags/{tagId}'.replace('{format}', 'json')
        path_params = {}
        if 'tag_id' in params:
    ...
    def get_tags_list(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_tags_list(callback=callback_function)
    ...
    def update_tag(self, tag_id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_tag(tag_id, callback=callback_function)
