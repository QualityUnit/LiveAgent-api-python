...
class FiltersApi(object):
    ...
    def create_filter(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_filter(callback=callback_function)
        ...
        resource_path = '/filters/'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_filter(self, filter_id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_filter(filter_id, callback=callback_function)
        ...
        if ('filter_id' not in params) or (params['filter_id'] is None):
            raise ValueError("Missing the required parameter `filter_id` when calling `delete_filter`")

        resource_path = '/filters/{filterId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_filter(self, filter_id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_filter(filter_id, callback=callback_function)
        ...
        # verify the required parameter 'filter_id' is set
        if ('filter_id' not in params) or (params['filter_id'] is None):
            raise ValueError("Missing the required parameter `filter_id` when calling `get_filter`")
    ...
    def get_filters(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_filters(callback=callback_function)
    ...
    def update_filter(self, filter_id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_filter(filter_id, callback=callback_function)
        ...
        # verify the required parameter 'filter_id' is set
        if ('filter_id' not in params) or (params['filter_id'] is None):
            raise ValueError("Missing the required parameter `filter_id` when calling `update_filter`")
