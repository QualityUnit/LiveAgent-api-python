...
class ApiApi(object):
    ...
    def generate_api_key(self, apikey_id, **kwargs):  # noqa: E501
        """Gets new api keys  # noqa: E501

        Get new api key  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.generate_api_key(apikey_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.generate_api_key_with_http_info(apikey_id, **kwargs)  # noqa: E501
        else:
            (data) = self.generate_api_key_with_http_info(apikey_id, **kwargs)  # noqa: E501
            return data

    def generate_api_key_with_http_info(self, apikey_id, **kwargs):  # noqa: E501
        """Gets new api keys  # noqa: E501

        Get new api key  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.generate_api_key_with_http_info(apikey_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('apikey_id' not in params or
                                                       params['apikey_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `apikey_id` when calling `generate_api_key`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apikeys/regenerateApiV3/{apikeyId}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def generate_api_v1_key(self, **kwargs):  # noqa: E501
        """Gets new api keys  # noqa: E501

        Get new api v1 key  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.generate_api_v1_key(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.generate_api_v1_key_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.generate_api_v1_key_with_http_info(**kwargs)  # noqa: E501
            return data

    def generate_api_v1_key_with_http_info(self, **kwargs):  # noqa: E501
        """Gets new api keys  # noqa: E501

        Get new api v1 key  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.generate_api_v1_key_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method generate_api_v1_key" % key
                )
            params[key] = val
        del params['kwargs']
