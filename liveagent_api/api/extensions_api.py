...
class ExtensionsApi(object):
    ...
    def get_extension(self, extension_id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_extension_with_http_info(extension_id, **kwargs)  # noqa: E501
            return data

    def get_extension_with_http_info(self, extension_id, **kwargs):  # noqa: E501
        """Gets Extension  # noqa: E501
    ...
    def get_extensions_count(self, **kwargs):  # noqa: E501
        """Gets count for extensions  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_extensions_count(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_extensions_count_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_extensions_count_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_extensions_count_with_http_info(self, **kwargs):  # noqa: E501
        """Gets count for extensions  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_extensions_count_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_extensions_count" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def get_extensions_list(self, **kwargs):  # noqa: E501
        """Gets list of extensions  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_extensions_list(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_extensions_list_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_extensions_list_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_extensions_list_with_http_info(self, **kwargs):  # noqa: E501
        """Gets list of extensions  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_extensions_list_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def set_extension(self, extension_id, **kwargs):  # noqa: E501
        """Set extension  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.set_extension(extension_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.set_extension_with_http_info(extension_id, **kwargs)  # noqa: E501
        else:
            (data) = self.set_extension_with_http_info(extension_id, **kwargs)  # noqa: E501
            return data

    def set_extension_with_http_info(self, extension_id, **kwargs):  # noqa: E501
        """Set extension  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.set_extension_with_http_info(extension_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['extension_id', 'number', 'department_id', 'status']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
