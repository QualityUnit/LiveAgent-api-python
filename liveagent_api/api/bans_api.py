...
class BansApi(object):
    ...
    def exclude_ip_ban(self, ip_address, **kwargs):  # noqa: E501
        """Exclude banned IP address  # noqa: E501

        Exclude IP from banned IP ranges  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.exclude_ip_ban(ip_address, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str ip_address: IP address you want exclude form IP Ban (required)
        :return: OkResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.exclude_ip_ban_with_http_info(ip_address, **kwargs)  # noqa: E501
        else:
            (data) = self.exclude_ip_ban_with_http_info(ip_address, **kwargs)  # noqa: E501
            return data

    def exclude_ip_ban_with_http_info(self, ip_address, **kwargs):  # noqa: E501
        """Exclude banned IP address  # noqa: E501

        Exclude IP from banned IP ranges  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.exclude_ip_ban_with_http_info(ip_address, async_req=True)
        >>> result = thread.get()
