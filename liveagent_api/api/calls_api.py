...
class CallsApi(object):
    ...
    def blind_call_transfer(self, call_id, **kwargs):  # noqa: E501
        """Transfers call to different department / agent  # noqa: E501

        Blind transfer can be called on active calls to transfer them to another department / agent  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.blind_call_transfer(call_id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.blind_call_transfer_with_http_info(call_id, **kwargs)  # noqa: E501
        else:
            (data) = self.blind_call_transfer_with_http_info(call_id, **kwargs)  # noqa: E501
            return data

    def blind_call_transfer_with_http_info(self, call_id, **kwargs):  # noqa: E501
        """Transfers call to different department / agent  # noqa: E501

        Blind transfer can be called on active calls to transfer them to another department / agent  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.blind_call_transfer_with_http_info(call_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method blind_call_transfer" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('call_id' not in params or
            ...
            raise ValueError("Missing the required parameter `call_id` when calling `blind_call_transfer`")  # noqa: E501
    ...
    def call_get_transfer_status(self, call_id, **kwargs):  # noqa: E501
        """Return the status of call  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.call_get_transfer_status(call_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.call_get_transfer_status_with_http_info(call_id, **kwargs)  # noqa: E501
        else:
            (data) = self.call_get_transfer_status_with_http_info(call_id, **kwargs)  # noqa: E501
            return data

    def call_get_transfer_status_with_http_info(self, call_id, **kwargs):  # noqa: E501
        """Return the status of call  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.call_get_transfer_status_with_http_info(call_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method call_get_transfer_status" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'call_id' is set
        if self.api_client.client_side_validation and ('call_id' not in params or
                                                       params['call_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `call_id` when calling `call_get_transfer_status`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/calls/{callId}/transfer_status', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
