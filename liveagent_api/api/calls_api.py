...
class CallsApi(object):
    ...
    def unhol_channel(self, call_id, channel_id, **kwargs):  # noqa: E501
    ...
    def unhol_channel_with_http_info(self, call_id, channel_id, **kwargs):  # noqa: E501
        """Unhold channel  # noqa: E501
        ...
        if ('call_id' not in params or
                params['call_id'] is None):
            raise ValueError("Missing the required parameter `call_id` when calling `unhol_channel`")  # noqa: E501
        # verify the required parameter 'channel_id' is set
        if ('channel_id' not in params or
                params['channel_id'] is None):
            raise ValueError("Missing the required parameter `channel_id` when calling `unhol_channel`")  # noqa: E501
