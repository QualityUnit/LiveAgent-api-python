...
class CompaniesApi(object):
    ...
    def register_company(self, company_id, registration_email, **kwargs):  # noqa: E501
        """Register company  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.register_company(company_id, registration_email, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.register_company_with_http_info(company_id, registration_email, **kwargs)  # noqa: E501
        else:
            (data) = self.register_company_with_http_info(company_id, registration_email, **kwargs)  # noqa: E501
            return data

    def register_company_with_http_info(self, company_id, registration_email, **kwargs):  # noqa: E501
        """Register company  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.register_company_with_http_info(company_id, registration_email, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method register_company" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'company_id' is set
        ...
        return self.api_client.call_api(
            '/companies/{companyId}/_register', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def unregister_company(self, company_id, **kwargs):  # noqa: E501
        """Unregister company  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.unregister_company(company_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.unregister_company_with_http_info(company_id, **kwargs)  # noqa: E501
        else:
            (data) = self.unregister_company_with_http_info(company_id, **kwargs)  # noqa: E501
            return data

    def unregister_company_with_http_info(self, company_id, **kwargs):  # noqa: E501
        """Unregister company  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.unregister_company_with_http_info(company_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method unregister_company" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'company_id' is set
        ...
        return self.api_client.call_api(
            '/companies/{companyId}/_unregister', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
