...
class AgentsApi(object):
    ...
    def login_key(self, user_id, **kwargs):  # noqa: E501
        """Get login key  # noqa: E501

        Get temporary (10 sec. valid ) key for user to login  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.login_key(user_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.login_key_with_http_info(user_id, **kwargs)  # noqa: E501
        else:
            (data) = self.login_key_with_http_info(user_id, **kwargs)  # noqa: E501
            return data

    def login_key_with_http_info(self, user_id, **kwargs):  # noqa: E501
        """Get login key  # noqa: E501

        Get temporary (10 sec. valid ) key for user to login  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.login_key_with_http_info(user_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='LoginKey',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_call_settings(self, user_id, voice_status, **kwargs):  # noqa: E501
        """Update general voice status  # noqa: E501

        Update general voice status  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_call_settings(user_id, voice_status, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str user_id: (required)
        :param str voice_status: (required)
        :return: OkResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_call_settings_with_http_info(user_id, voice_status, **kwargs)  # noqa: E501
        else:
            (data) = self.update_call_settings_with_http_info(user_id, voice_status, **kwargs)  # noqa: E501
            return data

    def update_call_settings_with_http_info(self, user_id, voice_status, **kwargs):  # noqa: E501
        """Update general voice status  # noqa: E501

        Update general voice status  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_call_settings_with_http_info(user_id, voice_status, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['user_id', 'voice_status']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_call_settings" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'user_id' is set
        ...
        query_params = []
        if 'voice_status' in params:
            query_params.append(('voiceStatus', params['voice_status']))  # noqa: E501
        ...
        return self.api_client.call_api(
            '/agents/{userId}/updateVoiceStatus', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
