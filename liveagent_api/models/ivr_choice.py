...
class IvrChoice(object):
    ...
    def __init__(self, dtmf=None, play=None, name=None, ivr=None, _configuration=None):  # noqa: E501
    ...
    def ivr(self, ivr):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and ivr is None:
