...
class BillingStatus(object):
    ...
    def __init__(self, status=None, valid_to_date=None, next_billing_date=None, errors=None, last_error_date=None, payment_compatible=None, _configuration=None):  # noqa: E501
