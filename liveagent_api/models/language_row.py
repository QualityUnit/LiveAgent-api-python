...
class LanguageRow(object):
    ...
    def __init__(self, name=None, code=None, eng_name=None, translated=None, is_default=None, active=None, is_custom=None, is_built_in=None, _configuration=None):  # noqa: E501
