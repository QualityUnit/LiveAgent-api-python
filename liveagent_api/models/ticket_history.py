...
class TicketHistory(object):
    ...
    def __init__(self, id=None, conversation_id=None, conversation_code=None, department_id=None, department_name=None, agent_id=None, status=None, date_from=None, date_to=None, elapsed_time=None, _configuration=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TicketHistory, dict):
