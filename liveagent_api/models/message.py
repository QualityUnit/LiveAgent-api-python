...
class Message(object):
    ...
    def __init__(self, id=None, userid=None, type=None, datecreated=None, format=None, message=None, visibility=None, _configuration=None):  # noqa: E501
    ...
    def type(self):
        ...
        M - MESSAGE Y - MESSAGE_LEGACY Q - QUOTED_TEXT I - INTERNAL F - FILE T - TITLE E - END D - DISCONNECT H - HEADER R - TRANSFER S - SYSTEM U - USERAGENT G - TAG V - VOICE 1 - VOICE_INTERNAL N - NOTE L - NOTE_FILE Z - FORMFIELD A - TEXT_HEADER O - TEXT_FOOTER J - STATUS B - SPLITTED W - RANKING_FEATURE_REWARD P - RANKING_FEATURE_PUNISHMENT C - RANKING_FEATURE_COMMENT K - SYSTEM_PUBLIC X - SYSTEM_VISITOR 0 - ERROR_FOOTER 2 - MERGED 3 - INVITATION_REROUTE 4 - TYPE_MESSAGE_UNDELIVERED 5 - TYPE_LINKED 6 - TYPE_REMOVED_ATTACHMENT  # noqa: E501
    ...
    def type(self, type):
        ...
        :type: str
        """
        allowed_values = ["M", "Y", "Q", "I", "F", "T", "E", "D", "H", "R", "S", "U", "G", "V", "1", "N", "L", "Z", "A", "O", "J", "B", "W", "P", "C", "K", "X", "0", "2", "3", "4", "5", "6"]  # noqa: E501
