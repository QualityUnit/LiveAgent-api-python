...
class Call(object):
    ...
    def reroute_time(self, reroute_time):
        ...
        """
        if (self._configuration.client_side_validation and
                reroute_time is not None and reroute_time > 120):  # noqa: E501
            raise ValueError("Invalid value for `reroute_time`, must be a value less than or equal to `120`")  # noqa: E501
        if (self._configuration.client_side_validation and
                reroute_time is not None and reroute_time < 10):  # noqa: E501
    ...
    def max_queue_time(self, max_queue_time):
        ...
        """
        if (self._configuration.client_side_validation and
                max_queue_time is not None and max_queue_time < 0):  # noqa: E501
    ...
    def max_ring_time(self, max_ring_time):
        ...
        """
        if (self._configuration.client_side_validation and
                max_ring_time is not None and max_ring_time < 0):  # noqa: E501
