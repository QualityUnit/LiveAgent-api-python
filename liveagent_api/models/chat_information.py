...
class ChatInformation(object):
    ...
    def __init__(self, id=None, subject=None, preview=None, chat_order=None, date_created=None, status_date_started=None, tags=None, rstatus=None, firstname=None, lastname=None, system_name=None, avatar_url=None, countrycode=None, city=None, department_id=None, agent_id=None, status=None, emails=None, _configuration=None):  # noqa: E501
