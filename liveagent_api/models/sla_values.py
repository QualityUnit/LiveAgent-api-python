...
class SlaValues(object):
    ...
    def __init__(self, first_answer=None, first_assign=None, first_resolve=None, next_answer=None, chat_answer=None, call_answer=None, _configuration=None):  # noqa: E501
