...
class Customer(object):
    ...
    def __init__(self, name=None, email=None, company=None, phone=None, address1=None, address2=None, city=None, state=None, country=None, zip=None, vat_id=None, ico_sk=None, dic_sk=None, _configuration=None):  # noqa: E501
