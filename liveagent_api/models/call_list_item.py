...
class CallListItem(object):
    ...
    def __init__(self, id=None, ticket_id=None, type=None, from_number=None, from_name=None, to_number=None, to_name=None, via_number=None, date_created=None, date_answered=None, date_finished=None, call_duration=None, _configuration=None):  # noqa: E501
