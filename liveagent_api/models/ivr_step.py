...
class IvrStep(object):
    ...
    def type(self):
        ...
        P - play message (URL in params), R - ring to agent (optional departmentId in params), V - redirect to voicemail, D - choice (see choices param) G - goto (IVR name in params)
