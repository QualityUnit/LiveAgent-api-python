...
class EventLogRow(object):
    ...
    def __init__(self, id=None, logid=None, line=None, filename=None, created=None, level=None, type=None, message=None, ip=None, groupid=None, _configuration=None):  # noqa: E501
