...
class TicketSla(object):
    ...
    def __init__(self, conversationid=None, sla_level_id=None, sla_level_name=None, first_answer=None, first_assign=None, first_resolve=None, next_answer=None, _configuration=None):  # noqa: E501
