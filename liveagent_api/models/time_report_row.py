...
class TimeReportRow(object):
    ...
    def __init__(self, id=None, agentid=None, agent=None, conversationid=None, ticket=None, parent_contactid=None, company=None, contactid=None, customer=None, customer_firstname=None, customer_lastname=None, customer_systemname=None, agent_ticket=None, reportdate=None, reportedtime=None, reportedtime_hhmmss=None, spenttime=None, dateinvoiced=None, note=None, type=None):  # noqa: E501
