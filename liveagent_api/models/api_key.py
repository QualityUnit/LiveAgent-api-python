...
class ApiKey(object):
    ...
    def __init__(self, id=None, key=None, valid_to_date=None, role=None, name=None, type=None, installid=None, userid=None, whitelist=None, _configuration=None):  # noqa: E501
