...
class Ban(object):
    ...
    def __init__(self, id=None, date_created=None, agent_id=None, start_ip=None, end_ip=None, date_valid=None, contact_id=None, conversation_id=None, reason=None):  # noqa: E501
