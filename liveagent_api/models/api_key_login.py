...
class ApiKeyLogin(object):
    ...
    def __init__(self, login=None, password=None, two_factor_token=None, valid_to_date=None, name=None, type=None, installid=None, whitelist='*', _configuration=None):  # noqa: E501
