...
class PhoneDevice(object):
    ...
    def __init__(self, id=None, type=None, number=None, name=None, reg_status=None, connection_host=None, connection_user=None, connection_pass=None, last_modified=None, user_agent=None, agent_id=None, trunk_id=None, pass_original_caller_id=None, params=None, _configuration=None):  # noqa: E501
    ...
    def reg_status(self, reg_status):
        ...
        if (self._configuration.client_side_validation and
                reg_status not in allowed_values):
            raise ValueError(
