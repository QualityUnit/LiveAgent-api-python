...
class User(object):
    ...
    def __init__(self, id=None, name=None, email=None, role=None, avatar_url=None, _configuration=None):  # noqa: E501
    ...
    def role(self, role):
        ...
        :type: str
        """
        allowed_values = ["owner", "admin", "agent", "visitor", "ext_admin", "reg_visitor", "system", "unknown_role"]  # noqa: E501
