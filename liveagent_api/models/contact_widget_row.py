...
class ContactWidgetRow(object):
    ...
    def __init__(self, id=None, name=None, type=None, online_code=None, offline_code=None, online_code_css=None, offline_code_css=None, provide=None, impressions=None, tickets=None, status=None, last_display_time=None, last_display_url=None):  # noqa: E501
