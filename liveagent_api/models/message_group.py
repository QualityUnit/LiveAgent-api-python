...
class MessageGroup(object):
    ...
    def __init__(self, id=None, parent_id=None, userid=None, user_full_name=None, type=None, status=None, datecreated=None, datefinished=None, sort_order=None, mail_msg_id=None, pop3_msg_id=None, messages=None, _configuration=None):  # noqa: E501
    ...
    def type(self):
        ...
        M - OFFLINE_LEGACY C - CHAT P - CALL V - OUTGOING_CALL 1 - INTERNAL_CALL I - INTERNAL U - INTERNAL_OFFLINE Z - INTERNAL_COLLAPSED S - STARTINFO T - TRANSFER R - RESOLVE J - POSTPONE X - DELETE B - SPAM G - TAG F - FACEBOOK W - TWITTER Y - RETWEET A - KNOWLEDGEBASE_START K - KNOWLEDGEBASE O - FORWARD Q - FORWARD_REPLY L - SPLITTED 2 - MERGED 3 - INCOMING_EMAIL 4 - OUTGOING_EMAIL 5 - OFFLINE 6 - TYPE_WHATSAPP 7 - TYPE_RECEIVED_ANSWER  # noqa: E501
    ...
    def type(self, type):
        ...
        :type: str
        """
        allowed_values = ["M", "C", "P", "V", "1", "I", "U", "Z", "S", "T", "R", "J", "X", "B", "G", "F", "W", "H", "E", "D", "N", "Y", "A", "K", "O", "Q", "L", "2", "3", "4", "5", "6", "7"]  # noqa: E501
