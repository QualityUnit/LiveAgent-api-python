...
class CannedMessage(object):
    ...
    def __init__(self, id=None, userid=None, departmentid=None, messagetext=None, keywords=None, _configuration=None):  # noqa: E501
    ...
    def messagetext(self, messagetext):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and messagetext is None:
            raise ValueError("Invalid value for `messagetext`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                messagetext is not None and len(messagetext) < 1):
