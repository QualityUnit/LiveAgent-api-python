...
class SlaHistory(object):
    ...
    def __init__(self, id=None, sla_level_id=None, sla_type=None, date_created=None, date_due=None, date_closed=None, total_time=None, elapsed_time=None):  # noqa: E501
