...
class AgentRow(object):
    ...
    def __init__(self, agentid=None, firstname=None, lastname=None, system_name=None, username=None, countrycode=None, avatar_url=None, roleid=None, departments_statuses=None, twofa=None, last_pswd_change=None, userstatus=None, _configuration=None):  # noqa: E501
